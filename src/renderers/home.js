...
const COPY = Object.freeze({
  id: Object.freeze({
    trustTitle: 'Kepercayaan dimulai dari pemeriksaan yang jelas', trustBadge: 'Periksa legalitas penyelenggara', trustText: 'Sebelum membayar, minta rincian tertulis tentang izin, program, harga, penerbangan, hotel, dan kebijakan pembatalan.',
    ...
    destinations: 'Inspirasi destinasi', testimonials: 'Cerita perjalanan', testimonialText: 'Kami belum menampilkan testimoni yang belum dapat diverifikasi. Gunakan panduan dan konsultasi untuk memulai dari kebutuhan Anda.',
    tools: 'Travel Tools', toolsText: 'Gunakan panduan alat perjalanan dan tautan pihak ketiga dengan syarat serta pengungkapan yang mudah ditemukan.',
    articles: 'Bacaan untuk merencanakan', local: 'Mulai dari Jakarta atau Bandung', localText: 'Pilih konteks awal yang paling nyaman untuk keluarga Anda. Percakapan dapat dimulai secara daring dan detailnya dikonfirmasi bersama.',
  ...
  en: Object.freeze({
    trustTitle: 'Trust starts with clear checks', trustBadge: 'Check organizer credentials', trustText: 'Before paying, ask for written details about credentials, programme, price, flights, hotels, and cancellation policy.',
    ...
    destinations: 'Destination inspiration', testimonials: 'Travel stories', testimonialText: 'We do not publish testimonials that cannot be verified. Use the guides and consultation to begin from your needs.',
    tools: 'Travel Tools', toolsText: 'Use travel-tool guidance and third-party links with terms and disclosures kept visible.',
    articles: 'Reading for planning', local: 'Begin in Jakarta or Bandung', localText: 'Choose the context that feels most convenient for your family. The conversation can start remotely and details are confirmed together.',
