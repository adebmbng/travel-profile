...
const COPY = Object.freeze({
  id: Object.freeze({
    ...
    informationPending: 'Gunakan panduan di setiap halaman untuk menyiapkan pertanyaan; detail akhir dikonfirmasi melalui konsultasi.',
  ...
  en: Object.freeze({
    ...
    informationPending: 'Use the guides on each page to prepare questions; final details are confirmed in consultation.',
